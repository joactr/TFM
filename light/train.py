...
def main():
    ...
    parser = argparse.ArgumentParser(description = "ASD Training")
    # Training details
    ...
    parser.add_argument('--windowSize',      type=float, default=51,  help='Number of frames of input winfow')
    ...
    while(1):        
        ...
        if epoch % args.testInterval == 0:        
            ...
            testLoss, testACC, testmap = s.evaluate_network(epoch, loader = valLoader, **vars(args))
            print("Evaluado")
            mAPs.append(testmap)
